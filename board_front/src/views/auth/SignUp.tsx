...
function SignUp() { // rfce: 함수형 컴포넌트 생성
  ...
  return (
    <div css={authStyle.containerStyle}>
      <h2 css={authStyle.titleStyle}>회원 가입</h2>
      <input type="email" placeholder='이메일' name='email' value={form.email} onChange={onInputChange} css={authStyle.inputStyle} />

      <input type="password" placeholder='비밀번호' name='password' value={form.password} onChange={onInputChange} css={authStyle.inputStyle} />

      <input type="password" placeholder='비밀번호 확인' name='passwordCheck' value={form.passwordCheck} onChange={onInputChange} css={authStyle.inputStyle} />
