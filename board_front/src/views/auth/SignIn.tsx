...
function SignIn() {
  ...
  return (
    <div css={containerStyle}>
      ...
      <input type="email" name='email' value={form.email} placeholder='이메일' onChange={onInputChange} css={inputStyle} />
      <input type="password" name='password' value={form.password} placeholder='비밀번호' onChange={onInputChange} css={inputStyle} />
